!!! info "Source Repository"
    This documentation is from [amiable-dev/llm-council](https://github.com/amiable-dev/llm-council).
    Last synced: 2026-01-03 | Commit: `f23f22e`
...
**Scoring Anchors**: Each score level has defined behavioral meaning (see [ADR-016](https://github.com/amiable-dev/llm-council/blob/f23f22e40be5d20dbdaa8adb0b034a8bff6f5c39/docs/adr/ADR-016-structured-rubric-scoring.md)):
